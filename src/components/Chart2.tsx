...
export const Chart2 = () => {
  var chartElement = document.createElement("div-chart2");
  ...
  var switcherElement = createSimpleSwitcher(
    formatterNames,
    formatterNames[0],
    function (formatter: string | number) {
      chart2.applyOptions({
        localization: {
  ...
  var chart2 = createChart(chartElement, {
    width: 600,
    height: 300,
    crosshair: {
  ...
  areaSeries.setData([
    ...
    { time: "2018-12-21", value: 72.9 },
    { time: "2018-12-24", value: 71.15 },
    { time: "2018-12-26", value: 74.0 },
    ...
    { time: "2019-01-11", value: 74.9 },
    { time: "2019-01-14", value: 73.37 },
    { time: "2019-01-15", value: 74.5 },
    { time: "2019-01-16", value: 74.61 },
    { time: "2019-01-17", value: 75.6 },
    ...
    { time: "2019-05-03", value: 80.0 },
    { time: "2019-05-06", value: 79.48 },
    { time: "2019-05-07", value: 77.9 },
...
function createSimpleSwitcher(
  ...
  var intervalElements = items.map(function (item: string) {
  ...
  function onItemClicked(item: any) {
    ...
    intervalElements.forEach(function (
      element: { classList: { toggle: (arg0: string, arg1: boolean) => void } },
      index: number | number
    ) {
